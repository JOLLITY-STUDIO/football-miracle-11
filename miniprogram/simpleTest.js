import { validateCardPlacement, getValidPlacements } from './utils/gameUtils.js'
...
const result5 = validateCardPlacement(testCard, fieldWithCard, 1, 3, false)
...
const result6 = validateCardPlacement(testCard, fieldWithCard, 1, 0, false)
