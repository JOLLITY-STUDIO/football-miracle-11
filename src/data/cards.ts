...
export const starathleteCards: athleteCard[] = [
  ...
  { id: 'SM5', nickname: 'Engine', realName: 'Kroos', type: 'mf', positionLabel: 'CMF', isStar: true, unlocked: true, unlockCondition: 'Unlocked', icons: ['pass', 'pass', 'pass', 'pass', 'press', 'press'], iconPositions: [{ type: 'pass', position: 'slot-topLeft' }, { type: 'pass', position: 'slot-topRight' }, { type: 'pass', position: 'slot-middleLeft' }, { type: 'pass', position: 'slot-middleRight' }, { type: 'press', position: 'slot-bottomLeft' }, { type: 'press', position: 'slot-bottomRight' }], immediateEffect: 'draw_synergy_1', imageUrl: '/images/cards/players/star-amf-killer-pass.png' },
