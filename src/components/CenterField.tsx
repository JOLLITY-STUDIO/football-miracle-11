...
export const CenterField: React.FC<Props> = ({
  ...
  return (
    <div className="w-[1000px] relative bg-green-600 shadow-inner overflow-visible">
      <div
      ...
      <div className="absolute inset-0 border-[6px] border-white/40 m-6 rounded-sm pointer-events-none" />
      <div className="absolute top-1/2 left-6 right-6 h-1 bg-white/40 pointer-events-none" />
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-24 border-b-[4px] border-x-[4px] border-white/40 bg-white/5 pointer-events-none rounded-b-lg" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-64 h-24 border-t-[4px] border-x-[4px] border-white/40 bg-white/5 pointer-events-none rounded-t-lg" />
      <div className="absolute top-6 left-6 w-12 h-12 border-r-[4px] border-b-[4px] border-white/40 rounded-br-full pointer-events-none" />
      <div className="absolute top-6 right-6 w-12 h-12 border-l-[4px] border-b-[4px] border-white/40 rounded-bl-full pointer-events-none" />
      <div className="absolute bottom-6 left-6 w-12 h-12 border-r-[4px] border-t-[4px] border-white/40 rounded-tr-full pointer-events-none" />
      <div className="absolute bottom-6 right-6 w-12 h-12 border-l-[4px] border-t-[4px] border-white/40 rounded-tl-full pointer-events-none" />
