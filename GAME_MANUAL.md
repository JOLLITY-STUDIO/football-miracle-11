...
### 阶段 1：掷硬币 (Coin Toss) 已改用猜拳胜者选择主客场
*   **目的**：决定主客场。
*   **流程**：玩家点击屏幕开始掷硬币。
...
| 位置 | 进攻图标 | 防守图标 | 放置区域 |
| :--- | :--- | :--- | :--- |
| **前锋 (FW)** | 2-3 点 | 0-1 点 | Zone 2, Zone 3, Zone 4, Zone 5 |
| **中场 (MF)** | 1-2 点 | 1-2 点 | Zone 1, Zone 2, Zone 5, Zone 6 |
| **后卫 (DF)** | 0-1 点 | 2-3 点 | Zone 0, Zone 1, Zone 6, Zone 7 |

### 7.2 协同卡加成
根据星数加成。铲球效果的卡可以处理世界波。
